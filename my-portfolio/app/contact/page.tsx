        ...
        <div className="relative min-h-screen overflow-hidden">
            ...
            <div className="relative z-10 flex items-center justify-center min-h-screen">
                ...
                <div
                    ref={hoverRef}
                    onClick={handleClick}
                    className="absolute text-[12vw] font-bold uppercase cursor-pointer select-none"
                >
                ...
                >
                    {WORD.split("").map((char, i) => (
                        <span
                            key={i}
                            className="letter text-[12vw] font-bold uppercase leading-none tracking-tighter text-black/90 dark:text-white/90 inline-block"
                            style={{ willChange: "transform" }}
                        >
                            {char}
                        </span>
            ...
            >
                ...
                >
                    <span className="block text-[6vw] font-light leading-[0.95] text-black dark:text-white tracking-tight transition-colors duration-300 group-hover:text-black/60 dark:group-hover:text-white/60">
                        faik.hasanov05@
                        <br />
                        gmail.com
                    </span>
